...
theme_custom <- function (base_size = 10, base_family = "serif") {
  theme_grey(base_size = base_size, base_family = base_family) %+replace%
    theme(
      ...
      text =               element_text(family = base_family, face = "plain", colour = "black", size = base_size, hjust = 0.5, vjust = 0.5, angle = 0, lineheight = 0.9, margin = margin(0.1, unit="cm"), debug = FALSE),
      ...
      legend.text =        element_text(family = base_family, size = base_size * 0.8,  margin = margin(0.2, unit="cm")),
