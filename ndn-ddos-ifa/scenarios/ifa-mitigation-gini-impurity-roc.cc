...
int main (int argc, char**argv)
{
  ...
  /* These are the same values mentioned in the SVM paper and the ChokIFA paper */
  ...
  // The ROC interest mitigation strategy is exactly the same as the normal strategy except it prints the ROC
  StackHelper helper2;
