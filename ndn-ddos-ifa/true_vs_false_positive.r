...
while (threshold < 0.0201) {
    ...
    print("filename is");
    print(paste("positive_rates_", substr(format(threshold, digits=4, nsmall=4), 2, 1000000L), ".txt", sep=""));
    data <- scan(file=paste("positive_rates_", substr(format(threshold, digits=4, nsmall=4), 2, 1000000L), ".txt", sep=""), what=character(), sep='\n')
