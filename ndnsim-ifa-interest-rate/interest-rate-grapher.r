...
data = read.table("packet-stuff.txt", header=T)
...
data = subset(data, Node %in% "NodeR2")
print(data)
...
png("src/ndnSIM/docs/source/_static/r2-interest-rate-test.png", width=500, height=250)
print(g.all)
retval <- dev.off()
