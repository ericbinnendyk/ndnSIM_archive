...
// This file contains an app and forwarding strategy for detecting and mitigating the attack.
// The detection algorithm works fine but the mitigation strategy is currently broken, so I am using multicast instead.
...
int main(int argc, char *argv[])
{
    ...
    ndn::StrategyChoiceHelper::InstallAll("/fine", "/localhost/nfd/strategy/multicast");
    ndn::StrategyChoiceHelper::InstallAll("/forged", "/localhost/nfd/strategy/multicast");
    //ndn::StrategyChoiceHelper::InstallAll("/stop", "/localhost/nfd/strategy/multicast");
    ...
    // install application on all four consumer nodes
    consumerHelper.Install(consumerNode1);
    ...
    consumerHelper1.SetPrefix("/forged");
    ...
    routerNodes.Add(Names::Find<Node>("NodeR1"));
    routerNodes.Add(Names::Find<Node>("NodeR2"));
    routerNodes.Add(Names::Find<Node>("NodeR3"));
    routerNodes.Add(Names::Find<Node>("NodeR4"));
    routerNodes.Add(Names::Find<Node>("NodeR5"));
    routerNodes.Add(Names::Find<Node>("NodeR6"));
    routerNodes.Add(Names::Find<Node>("NodeR7"));
    ndn::AppHelper detectorHelper("IfaDetector");
    detectorHelper.Install(routerNodes);

    ndn::AppHelper rateLogger("RateLogger");
    rateLogger.Install(Names::Find<Node>("NodeR4"));

    ndn::AppHelper pitSizeRecorder("PitSizeRecorder");
    pitSizeRecorder.Install(Names::Find<Node>("NodeR2"));

    // Add /prefix origins to ndn::GlobalRouter
    ndnGlobalRoutingHelper.AddOrigins("/fine", producer);
    ndnGlobalRoutingHelper.AddOrigins("/forged", producer);

    // Calculate and install FIBs
    ndn::GlobalRoutingHelper::CalculateRoutes();

    ndn::L3RateTracer::InstallAll("packet-stuff.txt", Seconds(1.0));
