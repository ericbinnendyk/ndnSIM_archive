...
int main (int argc, char**argv)
{
  ...
  justR2.Add(Names::Find<Node>("NodeR1"));

  StackHelper helper2;
  helper2.SetForwardingStrategy ("ns3::ndn::fw::BestRoute::InterestMitigationStrategy", "Threshold", "0.015");
