...
main(int argc, char* argv[])
{
  ...
  consumerNodes.Add(Names::Find<Node>("NodeC1"));
  consumerNodes.Add(Names::Find<Node>("NodeC2"));
  consumerNodes.Add(Names::Find<Node>("NodeC3"));
  consumerNodes.Add(Names::Find<Node>("NodeC4"));
